...
#ifndef __FATTREE_EXTTRAFFICGENERATIONAPP_H_
#define __FATTREE_EXTTRAFFICGENERATIONAPP_H_
 ...
 */
class ExtTrafficGenerationApp : public DCTCPControllerApp
{
protected:
	bool clientOn;
...
public:
	ExtTrafficGenerationApp() {
	    firstSend = true;
	}

	virtual ~ExtTrafficGenerationApp() {}
